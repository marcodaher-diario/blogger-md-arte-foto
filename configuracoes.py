...
<div class="separator" style="clear: both; text-align: center; margin-top: 10px;">
  <a href="https://shope.ee/SEU_LINK_AQUI" style="margin-left: 1em; margin-right: 1em;">
    <img border="0" data-original-height="319" data-original-width="1536" height="132" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhHYBTRiztv4UNKBsiwX8nQn1M00BUz-LtO58gTZ6hEsU3VPClePhQwPWw0NyUJGqXvm3vWbRPP6LPQS6m5iyI0UQBBKmdIkNYNuXmGaxv5eMac9R6i2e9MIU7_YmWeMKntQ1ZWlzplYlDYNJr5lGHiUvwJ1CuvQOLzbOT61kF3LQ0-nD4j3Xo4HJWeOG4/w640-h132/Banner%20Shopee%20Rodap%C3%A9.gif" width="640" />
  </a>
</div>

<div style="background-color: #f0f4f8; border-radius: 10px; padding: 20px; margin: 20px auto; text-align: center; border: 1px dashed #003366; max-width: 640px;">
    <p style="font-weight: bold; margin-bottom: 15px; color: #003366;">🚀 Gostou deste conteúdo? Não guarde só para você!</p>
    <a href="https://api.whatsapp.com/send?text=Confira este artigo incrível no blog do Marco Daher!" target="_blank" style="background-color: #25D366; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block;">
...
<div class="footer-marco-daher" style="background-color: #e1f5fe; border-radius: 15px; border: 1px solid rgb(179, 229, 252); color: #073763; font-family: Arial, Helvetica, sans-serif; line-height: 1.4; margin-top: 10px; padding: 25px; text-align: center;">
  ...
  <hr style="border: 0; border-top: 1px solid rgba(7, 55, 99, 0.133); margin: 20px 0px;" />
